...
from obst_grid import get_seq_mask
...
def main():
    ...
    parser.add_argument('--max_obst', type=int, default=38,
                        help='Only to decide the max possible number of obst in the frame')
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in range(dataloader.num_batches):
            ...
            for sequence in range(dataloader.batch_size):
                ...
                obst_seq = get_seq_mask(x_seq, d_seq, dataset_data, args.neighborhood_size, args.grid_size)
                ...
                # Forward prop
                outputs, _, _ = net(nodes[:-1], grid_seq[:-1], obst_seq[:-1], nodesPresent[:-1], hidden_states, cell_states)
